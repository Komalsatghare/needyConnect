...
export default function EditDonation() {
    ...
    const [formData, setFormData] = useState({
        itemName: '', category: '', quantity: 1, description: '', location: '',
    });
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            await api.put(`/donations/update/${id}`, { ...formData, quantity: Number(formData.quantity) });
            navigate('/dashboard');
        } catch (err) {
        ...
        <div className="container mx-auto px-4 py-8 max-w-3xl">
            <Card className="border-none shadow-md">
                <CardHeader>
                    ...
                    <CardDescription>Update the details of your donation listing.</CardDescription>
                </CardHeader>
                <form onSubmit={handleSubmit}>
                    <CardContent className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input name="itemName" required value={formData.itemName} onChange={handleChange} />
                        </div>
